    ...
    if ($data) {
        ...
        if ($mode) {
            foreach ($data as $v) {
                ...
                $html = "<li class=\"nav-item active\"><a $href class=\"nav-link\"> $text</a>";
...
//                        print_r($_v);
            ...
            foreach ($data as $v) {
                ...
                $html .= "<li class=\"nav-item  \"><a $href class=\"nav-link\"> $text</a>";
...
//                        </div>
    ...
    if (!$prevResult && !$nextResult) {
        ...
        $html .= '<div class="post-previous"><a href="' . $nextResult["link"] . '" rel="next"><span><i class="fa fa-angle-left"></i> Previous Post</span><h4>' . $nextResult["title"] . '</h4></a></div>';
//        $html .= '<div class="post-footer-box half next" style="width:100%"><a href="' . $nextResult["link"] . '" rel="next"><div class="post-footer-thumbnail"><img src="' . $nextResult["img"] . '"></div><span class="post-footer-label">Next Post</span><div class="post-footer-title"><h3>' . $nextResult["title"] . '</h3></div></a></div>';
        ...
        //没有下一篇
        //只显示上一篇
        $html .= '<div class="post-next"><a href="' . $prevResult["link"] . '" rel="prev"><span>Next Post <i class="fa fa-angle-right"></i></span><h4>' . $prevResult["title"] . '</h4></a></div>';
...
//        $html .= '<div class="post-footer-box half previous" style="width:100%"><a href="' . $prevResult["link"] . '" rel="prev"><div class="post-footer-thumbnail"><img src="' . $prevResult["img"] . '"></div><span class="post-footer-label">Previous Post</span><div class="post-footer-title"><h3>' . $prevResult["title"] . '</h3></div></a></div>';
        ...
        $html .= '<div class="post-previous"><a href="' . $prevResult["link"] . '" rel="next"><span><i class="fa fa-angle-left"></i> Previous Post</span><h4>' . $prevResult["title"] . '</h4></a></div>';
        $html .= '<div class="post-next"><a href="' . $nextResult["link"] . '" rel="prev"><span>Next Post <i class="fa fa-angle-right"></i></span><h4>' . $nextResult["title"] . '</h4></a></div>';
